  ...
  (e.instances = []),
    ...
    (e.prototype.i = function () {
      ...
      (this.u = 0),
        ...
        (this.m =
          -1 === getComputedStyle(this.t.containerEl).display.indexOf("flex")),
        this.t.listen &&
    ...
    (e.prototype.B = function (t) {
      t === s
        ...
        : (this.k(this.o),
          t === i ? this.O(this.o) : this.W(this.o),
          this.D(this.h));
    }),
    ...
    (e.prototype.W = function (t) {
      for (
        var i = 0,
          n = r.getComputedBox(this.t.containerEl).paddingBottom,
          s = t.length - 1;
        0 <= s;
        s--
      ) {
    ...
    window.addEventListener("scroll", e.hardRefreshAll),
  ...
  var r = {
    ...
    getComputedBox: function (t) {
      ...
      return {
        ...
        bottomWithMargin:
          window.pageYOffset + i.bottom + r.parseNumber(t.marginBottom),
      };
    },
  };
  return e;
